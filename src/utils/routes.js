...
export const routes = [
    ...
    { path: '/login', name: 'Login', component: Login, showOnNav: true, isProtected: false },
    { path: '/register', name: 'Register', component: Register, showOnNav: false, isProtected: false },
